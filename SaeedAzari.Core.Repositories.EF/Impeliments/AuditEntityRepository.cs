...
{
    public class AuditEntityRepository<TKey, TEntity, TContext>(TContext efDbContext, IApplicationContext applicationContext) : EntityRepository<TKey, TEntity, TContext>(efDbContext, applicationContext), IAuditEntityRepository<TKey, TEntity>
    ...
    public class AuditEntityRepository<TEntity, TContext>(TContext efDbContext, IApplicationContext applicationContext) : AuditEntityRepository<Guid, TEntity, TContext>(efDbContext, applicationContext), IAuditEntityRepository<TEntity>
